...
** Login.jsx refactor
this.refs: { email, name, password }

validate on change, different method in each component
...
checkForDuplicates (name) {
  ...
  else do the same as login.jsx is currently doing
}

create new files for these, then
import these components in login.jsx

then pull them into form

<div className='login-form'>
  <EmailInput existingValues={this.props.emails} ref={ref => this.refs.email = ref} />
